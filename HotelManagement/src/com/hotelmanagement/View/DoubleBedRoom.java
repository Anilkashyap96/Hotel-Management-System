...
/**
 * Servlet implementation class DoubleBedRoom
 */
@WebServlet("/DoubleBedRoom")
public class DoubleBedRoom extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tr><td>Room Type<input type=text name=roomtype value=\"doublebedroom\"></tr>");
