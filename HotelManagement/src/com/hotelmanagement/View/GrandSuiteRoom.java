...
/**
 * Servlet implementation class GrandSuiteRoom
 */
@WebServlet("/GrandSuiteRoom")
public class GrandSuiteRoom extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tr><td>Room Type<input type=text name=roomtype value=\"grand  suite\"></tr>");
