...
/**
 * Servlet implementation class SingleBedRoom
 */
@WebServlet("/SingleBedRoom")
public class SingleBedRoom extends HttpServlet {
	...
	out.println("<tr><td>Room Type<input type=text name=roomtype value=\"singlebedroom \"></tr>");
